...
const ServicesSection: React.FC = () => {
  ...
  const services = {
    "Society Work": {
      ...
      description:
        'We "SAI STAR CONSULTANCY" (EXPERT IN SOCIETY MANAGEMENT WORK) are committed to providing the best legal & advisory services to the housing societies.',
      left: [
    ...
    "Building Redevelopment": {
      ...
      description:
        "Our redevelopment consultancy helps societies navigate through the complex process from conception to completion.",
      left: [
    ...
    "RERA Work": {
      ...
      description:
        "We specialize in all aspects of Real Estate Regulatory Authority compliance and documentation.",
      left: [
        { id: 1, title: "RERA Agent Registration" },
        { id: 2, title: "RERA Project Registration" },
      ],
      right: [{ id: 3, title: "RERA Compliance" }],
    },
    "Real Estate": {
      image: "https://images.pexels.com/photos/323780/pexels-photo-323780.jpeg",
      description:
        "Our real estate services cover all aspects of property transactions and management.",
      left: [
    ...
    Legal: {
      ...
      description:
        "Our comprehensive legal services cover a wide range of requirements for individuals and organizations.",
      left: [
    ...
    Insurance: {
      ...
      description:
        "We provide complete insurance advisory services for personal and property protection.",
      left: [
        { id: 1, title: "LIC" },
        { id: 2, title: "Health Insurance" },
      ],
      right: [{ id: 3, title: "Term Plan" }],
    },
  };
        ...
        <section className="services-hero-section">
          <div className="container">
            ...
            <p className="services-subtitle">
              Comprehensive consultancy services tailored to meet your society
              management, legal, and real estate needs.
            </p>
          </div>
        </section>
          ...
          <div className="services-details">
            ...
            <div className="services-list">
              <div className="services-column">
                {services[activeTab as keyof typeof services].left.map(
                  (service) => (
              ...
              <div className="services-column">
                {services[activeTab as keyof typeof services].right.map(
                  (service) => (
                    <ServiceItem key={service.id} title={service.title} />
                  )
                )}
